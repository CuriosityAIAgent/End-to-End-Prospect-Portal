...
function draftInstructions(hasConfirmed: boolean): string {
  ...
  return [
    ...
    '- "plausibility": A banker attestation. Given the client\'s career arc, seniority and market experience, state the banker\'s professional assessment that the stated wealth level is consistent and proportionate with the asset base a person of this profile would be expected to have accumulated. Write it as the banker\'s judgement (e.g. "On the basis of the client\'s career and market experience, the stated wealth is consistent with the asset base expected of …"). Do NOT produce a documentary-evidence checklist, do NOT list documents to obtain during KYC, and do NOT claim documents you have been shown.',
    "",
    "CRITICAL RULES:",
    "- Never fabricate facts, figures, dates, employers, or amounts. Use ONLY what the inputs support.",
    '- Preserve specific figures VERBATIM. Any monetary amount, percentage, valuation, or named institution in the inputs (e.g. "$30m at Goldman Sachs") MUST appear in the statement exactly as given — never soften a concrete figure into vague language (e.g. "a significant banking relationship") and never drop it.',
